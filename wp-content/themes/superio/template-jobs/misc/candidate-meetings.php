...
<div class="box-dashboard-wrapper">
	<h3 class="widget-title"><?php esc_html_e('Sastanci', 'superio'); ?></h3>
                    ...
                    <div class="righ-inner flex-middle-sm">
                		...
                		<div class="action-button">
                			...
                			<?php if ( $status != 'cancel') { ?>
	                			<a data-toggle="tooltip" title="<?php esc_attr_e('Otkaži sastanak', 'superio'); ?>" href="javascript:void(0);" class="btn-action-icon btn-cancel-job-meeting cancel" data-meeting_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-pro-cancel-meeting-nonce' )); ?>"><i class="ti-close"></i></a>
	                		<?php } ?>
                		</div>
                    </div>
            	</div>
