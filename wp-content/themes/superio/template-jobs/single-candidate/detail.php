    ...
    <ul class="list">
        ...
        <?php if ( $experience_time ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo esc_html__('Iskustvo', 'superio'); ?></div>
        ...
        <?php if ( $gender ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo esc_html__('Pol', 'superio'); ?></div>
        ...
        <?php if ( $age ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo esc_html__('Godine', 'superio'); ?></div>
        ...
        <?php if ( $qualification ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo esc_html__('Kvalifikacije', 'superio'); ?></div>
        ...
        <?php if ( $languages ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo esc_html__('Jezici', 'superio'); ?></div>
        ...
        <?php if ( $email ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo esc_html__('Email', 'superio'); ?></div>
        ...
        <?php if ( $phone ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo esc_html__('Telefon', 'superio'); ?></div>
