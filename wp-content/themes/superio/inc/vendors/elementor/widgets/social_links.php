...
class Superio_Elementor_Social_Links extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Social Links', 'superio' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'superio' ),
        ...
        $this->start_controls_section(
            'section_title_style',
            [
                'label' => esc_html__( 'Social', 'superio' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'hover_color',
            [
                'label' => esc_html__( 'Hover Color', 'superio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Superio_Elementor_Social_Links );
} else {
    Plugin::instance()->widgets_manager->register( new Superio_Elementor_Social_Links );
}