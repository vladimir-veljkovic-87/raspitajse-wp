								...
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_container">
										<tr>
											<td align="center" valign="top">
												<!-- Header -->
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header" style="background-color:#fafffb;border-bottom: 1px solid #e5e5e5;">
													<tr>
														<td id="header_wrapper" style="padding:24px 32px;">
															<table border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	<!-- Title (left) -->
																	<td valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size:24px; font-weight:300; line-height:1.3; color:#1967d2; text-align:left;">
