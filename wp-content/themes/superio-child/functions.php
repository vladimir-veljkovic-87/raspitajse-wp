...
add_action('elementor/widgets/widgets_registered', function() {
    ...
    // Učitaj child klasu (samo jednom)
    require_once $file;
    ...
    // Unregister original widget (zavisi od verzije Elementora)
    ...
    // Register child widget (zavisi od verzije Elementora)
