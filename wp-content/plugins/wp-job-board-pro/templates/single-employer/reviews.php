	...
	<div id="review_form_wrapper" class="commentform">
		<div id="review_form">
			<?php
				...
				$comment_form['comment_field'] .= '<div class="form-group"><label>'.esc_html__( 'Recenzija', 'wp-job-board-pro' ).'</label><textarea id="comment" class="form-control" placeholder="'.esc_attr__( 'Write Comment', 'wp-job-board-pro' ).'" name="comment" cols="45" rows="5" aria-required="true"></textarea></div>';
