...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="the-comment media">
		...
		<div class="comment-box media-body">
			...
			<div class="star-rating clear pull-right" title="<?php echo sprintf( esc_attr__( 'Rated %d out of 5', 'wp-job-board-pro' ), $rating ) ?>">
			...
			<div class="meta">
				<div class="info-meta">
					...
					<?php if ( $comment->comment_approved == '0' ) : ?>
						<span class="meta"><em><?php esc_html_e( 'Your comment is awaiting approval', 'wp-job-board-pro' ); ?></em></span>
					<?php else : ?>
						<span class="meta">
