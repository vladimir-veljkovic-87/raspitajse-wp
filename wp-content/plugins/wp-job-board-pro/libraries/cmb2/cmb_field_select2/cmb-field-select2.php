...
class PW_CMB2_Field_Select2 {
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'pw-select2-init', $asset_path . '/js/script.js', array( 'cmb2-scripts', 'wpjbp-select2', 'jquery-ui-sortable' ), self::VERSION );
		wp_enqueue_style( 'pw-select2-tweaks', $asset_path . '/css/style.css', array( 'wpjbp-select2' ), self::VERSION );
	}
}
