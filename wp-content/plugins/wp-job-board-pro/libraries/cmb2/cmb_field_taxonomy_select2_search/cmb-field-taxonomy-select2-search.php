...
class PW_CMB2_Field_Taxonomy_Select2_Search {
	...
	public function __construct() {
		...
		// Ajax endpoints.
		add_action( 'wjbp_ajax_wpjb_search_terms',  array($this, 'search_terms') );
	}
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'pw-taxonomy-select2-loadmore-init', $asset_path . '/js/script.js', array( 'cmb2-scripts', 'wpjbp-select2', 'jquery-ui-sortable' ), self::VERSION );
		wp_enqueue_style( 'pw-taxonomy-select2-loadmore-tweaks', $asset_path . '/css/style.css', array( 'wpjbp-select2' ), self::VERSION );

		wp_localize_script( 'pw-taxonomy-select2-loadmore-init', 'wp_job_board_pro_tax_search_opts', array(
